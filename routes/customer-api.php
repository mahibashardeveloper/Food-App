...
Route::group(
    ...
    function () {
        ...
        Route::post('/login', [CustomerController::class, 'login'])->name('Auth.Login');

        Route::post('/forgot', [CustomerController::class, 'forgot'])->name('Auth.Forgot');

        Route::post('/reset', [CustomerController::class, 'reset'])->name('Auth.Reset');
