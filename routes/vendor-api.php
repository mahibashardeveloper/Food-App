...
Route::group(
    ...
    function () {
        ...
        Route::post('/login', [vendorController::class, 'login'])->name('Auth.Login');

        Route::post('/forgot', [vendorController::class, 'forgot'])->name('Auth.Forgot');

        Route::post('/reset', [vendorController::class, 'reset'])->name('Auth.Reset');
