        ...
        <div class="container-fluid" v-if="tableData.length > 0 && loading === false">
            ...
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-3">
                ...
                <div class="w-100 h-100" v-if="each.avatar !== null">
                    <img class="img-fluid slider mb-3 rounded-4 overflow-hidden" :src="'/storage/media/image/'+each.avatar" alt="slider image">
                    <div class="row justify-content-between align-items-center px-3">
                        <button type="button" class="col-5 btn rounded-3 btn-secondary" @click="manageModal(1, each.id)">
                            Edit
                        </button>
                        <button type="button" class="col-5 btn rounded-3 btn-danger" @click="deleteModal(1, each.id)">
                            Delete
                        </button>
                    </div>
                </div>
