            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-control" v-model="deliveryManParam.full_name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-control" v-model="deliveryManParam.email">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-control" v-model="deliveryManParam.phone_number">
                        <div class="error-text" v-if="error != null && error.phone_number !== undefined" v-text="error.name[0]"></div>
                    </div>
                </div>
                <div class="modal-footer border-0">
                    ...
                    <button type="button" class="btn btn-theme create" @click="manageDeliveryMan">
                        <span v-if="createLoading === false">
                            <span v-if="deliveryManParam.id === ''"> save </span> <span v-if="deliveryManParam.id !== ''"> Update </span>
                        </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-3">
                ...
                <div class="modal-footer border-0 d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-theme delete col-5" aria-label="Confirm" @click="deleteDeliveryMan" v-if="deleteLoading === false">Delete</button>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                deliveryManParam: { full_name: '', email: '', phone_number: '' },
        ...
        methods: {
            ...
            deleteDeliveryMan() {
                ...
                apiService.POST(apiRoutes.deliveryManDelete, this.deleteParam, (res) => {
            ...
            deleteModal(type, id) {
                if (type === 1) {
                    ...
                    this.selected = [];
                    this.deliveryManParam = { id: '', name: '', avatar: '' };
                    this.current_page = 1;
            ...
            getDeliveryMan() {
                apiService.POST(apiRoutes.deliveryManList, '', (res) => {
                    if (res.status === 200) {
            ...
            getSingle(id = null) {
                ...
                apiService.POST(apiRoutes.deliveryManSingle, param, (res) => {
                    if (res.status === 200) {
                        this.deliveryManParam = res.data;
                    } else {
                        this.error = res.errors;
                    }
                });
            ...
            create() {
                ...
                this.error = null;
                apiService.POST(apiRoutes.deliveryManCreate, this.deliveryManParam, (res) => {
            ...
            edit() {
                this.createLoading = true;
                this.error = null;
                apiService.POST(apiRoutes.deliveryManUpdate, this.deliveryManParam, (res) => {
                    this.createLoading = false;
                    if (res.status === 200) {
                        this.getDeliveryMan();
                        this.$toast.success(res.msg, {position: "bottom-right"});
