            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 col-12">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <label for="file-upload">
                                ...
                                <span v-if="vendorParam.avatar === null" class="modal-avatar">
                                ...
                                <img class="img-fluid modal-avatar" v-if="vendorParam.avatar !== null" :src="'/storage/media/image/'+vendorParam.avatar" alt="avatar">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-control" v-model="vendorParam.full_name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control" v-model="vendorParam.email">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="password" name="password" class="form-control" v-model="vendorParam.password">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="confirm_password" name="confirm_password" class="form-control"  v-model="vendorParam.password_confirmation">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="phone_number" name="phone_number" class="form-control"  v-model="vendorParam.phone_number">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="submit" class="btn btn-theme create" @click="manageVendor">

                        <span v-if="createLoading === false">

                            <span v-if="vendorParam.id === ''"> Save </span>

                            <span v-if="vendorParam.id !== ''"> Update </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-footer border-0 d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-theme cancel col-5" @click="deleteModal(2,'')">

                        Close

                    </button>

                    <button type="submit" class="btn btn-theme delete col-5" aria-label="Confirm" @click="deleteVendor" v-if="deleteLoading === false">
...
export default {
    ...
    methods: {
        ...
        attachFile(event) {
            ...
            apiService.UPLOAD(apiRoutes.media, formData, (res) => {
                ...
                if (res.status === 200) {
                    ...
                    this.vendorParam.avatar = res.data.file_path
        ...
        deleteVendor() {
            ...
            apiService.POST(apiRoutes.vendorDelete, this.deleteParam, (res) => {
        ...
        deleteModal(type, id) {
            ...
            if (type === 1) {
                ...
                this.vendorParam = { id: '', avatar: '', full_name: '', email: '', password: '', password_confirmation: '', phone_number: '' };
        ...
        manageModal(type, data = null) {
            ...
            this.vendorParam = { id: '', avatar: null, full_name: '', email: '', phone_number: '', password: '', password_confirmation: '' };
        ...
        getVendor() {
            ...
            apiService.POST(apiRoutes.vendorList, '', (res) => {
        ...
        getSingle(id = null) {
            ...
            apiService.POST(apiRoutes.vendorSingle, param, (res) => {

                if (res.status === 200) {

                    this.vendorParam = res.data;
        ...
        create() {
            ...
            apiService.POST(apiRoutes.vendorCreate, this.vendorParam, (res) => {
        ...
        edit() {
            ...
            apiService.POST(apiRoutes.vendorUpdate, this.vendorParam, (res) => {
