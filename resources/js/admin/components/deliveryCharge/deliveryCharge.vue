    ...
    <div class="card-body">
        ...
        <div class="card-list" v-if="tableData.length > 0 && loading === false">
            ...
            <div class="row border-bottom body-section align-items-center" v-for="(each) in tableData">
                ...
                <div class="col-12 col-sm-6 col-md-4 py-2">
                    <div class="marge">Delivery Charge Name</div>
                    <div class="d-flex align-items-center">
                        ...
                        {{each.deliveryChargeName}}
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-4">
                    {{each.deliveryChargeAmount}}
                </div>
                <div class="col-12 col-sm-6 col-md-4 py-2">
            ...
            <div class="modal-content p-3">
                <div class="modal-header border-0">
                    <h1 class="modal-title fw-bold fs-5" id="exampleModalLabel">
                        <span v-if="deliveryChargeParam.id === ''">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="deliveryChargeName" class="form-label">
                            Delivery Charge Name
                        </label>
                        <input type="text" id="deliveryChargeName" name="deliveryChargeName" class="form-control" v-model="deliveryChargeParam.deliveryChargeName">
                        <div class="error-text" v-if="error != null && error.deliveryChargeName !== undefined" v-text="error.deliveryChargeName[0]"></div>
                    </div>
                    <div class="mb-3">
                        <label for="deliveryChargeAmount" class="form-label">
                            Delivery Charge Amount
                        </label>
                        <input type="text" id="deliveryChargeAmount" name="deliveryChargeAmount" class="form-control" v-model="deliveryChargeParam.deliveryChargeAmount">
                        <div class="error-text" v-if="error != null && error.deliveryChargeAmount !== undefined" v-text="error.deliveryChargeAmount[0]"></div>
                    </div>
                </div>
                <div class="modal-footer border-0">
                    ...
                    <button type="button" class="btn btn-theme create" @click="manageDeliveryCharge">
                        <span v-if="createLoading === false">
                            <span v-if="deliveryChargeParam.id === ''"> save </span> <span v-if="deliveryChargeParam.id !== ''"> Update </span>
                        </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-3">
                ...
                <div class="modal-footer border-0 d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-theme delete col-5" aria-label="Confirm" @click="deleteDeliveryCharge" v-if="deleteLoading === false">Delete</button>
    ...
    export default {
        ...
        methods: {
            ...
            deleteDeliveryCharge() {
                ...
                apiService.POST(apiRoutes.deliveryChargeDelete, this.deleteParam, (res) => {
            ...
            deleteModal(type, id) {
                if (type === 1) {
                    ...
                    this.selected = [];
                    this.deliveryChargeParam = { id: '', deliveryChargeName: '', deliveryChargeAmount: '' };
                    this.current_page = 1;
            ...
            getDeliveryCharge() {
                apiService.POST(apiRoutes.deliveryChargeList, '', (res) => {
                    if (res.status === 200) {
            ...
            manageDeliveryCharge() {
                if (this.deliveryChargeParam.id) {
                    this.edit();
                } else {
                    this.create();
                }
            ...
            getSingle(id = null) {
                ...
                apiService.POST(apiRoutes.deliveryChargeSingle, param, (res) => {
                    if (res.status === 200) {
                        this.deliveryChargeParam = res.data;
                    } else {
                        this.error = res.errors;
                    }
                });
            ...
            create() {
                ...
                this.error = null;
                apiService.POST(apiRoutes.deliveryChargeCreate, this.deliveryChargeParam, (res) => {
            ...
            edit() {
                this.createLoading = true;
                this.error = null;
                apiService.POST(apiRoutes.deliveryChargeUpdate, this.deliveryChargeParam, (res) => {
                    this.createLoading = false;
                    if (res.status === 200) {
                        this.getDeliveryCharge();
                        this.$toast.success(res.msg, {position: "bottom-right"});
            ...
            list() {
                ...
                apiService.POST(apiRoutes.deliveryChargeList, this.formData, (res) => {
                    this.loading = false;
                    this.selected = [];
                    if (res.status === 200) {
