            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="full_name" name="full_name" class="form-control" v-model="subAdminParam.full_name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control" v-model="subAdminParam.email">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="phone_number" name="phone_number" class="form-control"  v-model="subAdminParam.phone_number">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="submit" class="btn btn-theme create" @click="manageSubAdmin">

                        <span v-if="createLoading === false">

                            <span v-if="subAdminParam.id === ''"> Save </span>

                            <span v-if="subAdminParam.id !== ''"> Update </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-footer border-0 d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-theme delete col-5" aria-label="Confirm" @click="deleteSubAdmin" v-if="deleteLoading === false">
    ...
    export default {
        ...
        methods: {
            ...
            attachFile(event) {
                ...
                apiService.UPLOAD(apiRoutes.media, formData, (res) => {
                    ...
                    if (res.status === 200) {
                        ...
                        this.subAdminParam.avatar = res.data.file_path
            ...
            deleteSubAdmin() {
                ...
                apiService.POST(apiRoutes.subAdminDelete, this.deleteParam, (res) => {
            ...
            getSubAdmin() {
                ...
                apiService.POST(apiRoutes.subAdminList, '', (res) => {

                    if (res.status === 200) {

                        this.subAdmin = res.data.data
            ...
            getSingle(id = null) {
                ...
                apiService.POST(apiRoutes.subAdminSingle, param, (res) => {

                    if (res.status === 200) {

                        this.subAdminParam = res.data;
            ...
            create() {
                ...
                apiService.POST(apiRoutes.subAdminCreate, this.subAdminParam, (res) => {
            ...
            edit() {
                ...
                apiService.POST(apiRoutes.subAdminUpdate, this.subAdminParam, (res) => {
