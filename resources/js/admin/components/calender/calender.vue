<template>
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <form class="my-2">
                ...
                <div class="position-relative">
                    ...
                    <input type="search" class="form-control ps-5" placeholder="Search here" v-model="formData.q" @keyup="SearchData">
    ...
    <div class="card-body">
        ...
        <div class="card-list" v-if="tableData.length > 0 && loading === false">
            ...
            <div class="row body-section align-items-center" v-for="(each) in tableData">

                <div class="col-12 col-md-4 py-2">

                    <div class="marge"> Calender Date. </div>
            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="date" placeholder="day, month, year" id="date" class="form-control" v-model="calenderParam.date">

                        <div class="error-text" v-if="error != null && error.date !== undefined" v-text="error.date[0]"></div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="time" name="time" placeholder="00:00" id="time" class="form-control" v-model="calenderParam.time">

                        <div class="error-text" v-if="error != null && error.time !== undefined" v-text="error.time[0]"></div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="topic" id="topic" class="form-control" v-model="calenderParam.topic">

                        <div class="error-text" v-if="error != null && error.topic !== undefined" v-text="error.topic[0]"></div>
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="button" class="btn btn-theme create" @click="manageCalender">

                        <span v-if="createLoading === false">

                            <span v-if="calenderParam.id === ''"> save </span> <span v-if="calenderParam.id !== ''"> Update </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-footer border-0 d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-theme delete col-5" aria-label="Confirm" @click="deleteCalender" v-if="deleteLoading === false">Delete</button>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                calenderParam: { id: '', date: '', time: '', topic: '' },
        ...
        methods: {
            ...
            deleteCalender() {
                ...
                apiService.POST(apiRoutes.calenderDelete, this.deleteParam, (res) => {
            ...
            deleteModal(type, id) {
                ...
                if (type === 1) {
                    ...
                    this.calenderParam = { id: '', date: '', time: '', topic: '' };
            ...
            getCalender() {
                ...
                apiService.POST(apiRoutes.calenderList, '', (res) => {

                    if (res.status === 200) {

                        this.calender = res.data.data
            ...
            getSingle(id = null) {
                ...
                apiService.POST(apiRoutes.calenderSingle, param, (res) => {

                    if (res.status === 200) {

                        this.calenderParam = res.data;
            ...
            create() {
                ...
                apiService.POST(apiRoutes.calenderCreate, this.calenderParam, (res) => {
            ...
            edit() {
                ...
                apiService.POST(apiRoutes.calenderUpdate, this.calenderParam, (res) => {
            ...
            list() {
                ...
                apiService.POST(apiRoutes.calenderList, this.formData, (res) => {
