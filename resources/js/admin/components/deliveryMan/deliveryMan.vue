            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control" v-model="deliveryManParam.email">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="phone_number" name="phone_number" class="form-control"  v-model="deliveryManParam.phone_number">
        ...
        attachFile(event) {
            ...
            apiService.UPLOAD(apiRoutes.media, formData, (res) => {
                ...
                if (res.status === 200) {
                    ...
                    this.deliveryManParam.avatar = res.data.file_path
