...
class MerchantService
{
    ...
    public static function login($request)
    {
        ...
        try {
            ...
            if (Auth::guard('merchants')->attempt($credential, $request->remember)) {

                return ['status' => 200, 'data' => Auth::guard('merchants')->user()];
    ...
    public static function forgot($request)
    {
        ...
        try {
            ...
            $userInfo = Merchants::where('email', $input['email'])->first();
    ...
    public static function reset($request)
    {
        ...
        try {
            ...
            $userInfo = Merchants::where(['email' => $input['email'], 'reset_code' => $input['code']])->first();
    ...
    public static function profile_details($request)
    {
        ...
        try {
            ...
            $user_id = Auth::guard('merchants')->id();

            $user = Merchants::with('media')->where('id', $user_id)->first();
    ...
    public static function profile_update($request)
    {
        ...
        try {
            ...
            $user = Merchants::where('id', Auth::guard('merchants')->id())->first();
